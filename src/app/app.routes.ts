...
export const routes: Routes = [
  ...
  { path: 'gastos-uniao-aposentadorias-2025', component: AposentadoriasPensoesComponent },
  { path: 'custo-juros-divida', component: CustoJurosDividaComponent },
  { path: 'custo-juros-divida-2025', component: CustoJurosDividaComponent },
  ...
  { path: 'gastos-defesa-aposentadoria-2025', component: GastosDefesaAposentadoriaComponent },
  ...
  { path: 'gasto-bolsa-familia-2025', component: GastosBolsaFamiliaComponent },
  ...
  { path: 'gastos-seguranca-2025', component: GastosSegurancaComponent },
  { path: 'analises/gastos-seguranca', component: GastosSegurancaComponent },
  { path: 'gastos-educacao', component: GastosEducacaoComponent },
  { path: 'investimentos-educacao-2025', component: GastosEducacaoComponent },
