...
export class AposentadoriasPensoesComponent implements OnInit {
  ...
  setupSEO(): void {
    ...
    this.titleService.setTitle('Gastos da União com Aposentadorias e Pensões - Análise das Despesas 2025 | Brasil Transparente');
    ...
    this.metaService.updateTag({ 
      property: 'og:title', 
      content: 'Gastos da União com Aposentadorias e Pensões - Análise das Despesas 2025' 
    });
