...
export class GastosSegurancaComponent implements OnInit {
  ...
  setupSEO(): void {
    ...
    this.metaService.updateTag({ 
      name: 'keywords', 
      content: 'gastos segurança pública 2025, orçamento segurança federal, investimentos segurança Brasil, programas segurança governo, Fundo Nacional de Segurança, prevenção violência' 
    });
